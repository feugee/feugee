...
- The Navbar is deliberately excluded, full stop. Blending it would mean flattening the header (multicolor logo + Menu) into one blend group and restructuring the Menu dropdown out of it; that cost was judged not worth the payoff, so the Navbar keeps its plain white chrome.
