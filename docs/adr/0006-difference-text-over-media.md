...
- The Navbar is deliberately excluded, full stop. Blending it would mean flattening the header (multicolor logo + Menu) into one blend group and restructuring the Menu dropdown out of it; that cost was judged not worth the payoff. Its chrome stays unblended — plain white at the top of the page, and frosted translucent once the visitor scrolls.
